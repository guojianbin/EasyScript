...
namespace Engine.Tasks {
	...
	public class Task : Disposable {
		...
		public Observer onStart {
			get { return _onStart; }
			set { _onStart = value; }
		}

		public Observer onError {
			get { return _onError; }
			set { _onError = value; }
		}

		public Observer onComplete {
			get { return _onComplete; }
			set { _onComplete = value; }
		}

		public Observer onDispose {
			get { return _onDispose; }
			set { _onDispose = value; }
		}

		public static T Start<T>(T task) where T : Task {
			task.Start();
			return task;
		}
