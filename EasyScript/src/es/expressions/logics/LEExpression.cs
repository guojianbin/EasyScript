...
/// @author Easily
/// </summary>
public class LEExpression : LogicExpression {

	private readonly IRightExpression _value1;
	private readonly IRightExpression _value2;

	public LEExpression(IRightExpression value1, IRightExpression value2) {
		_value1 = value1;
		_value2 = value2;
	}
	...
	public override string ToString() {
		return string.Format("LE Value1: {0}, Value2: {1}", _value1, _value2);
	}
